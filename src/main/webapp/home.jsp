          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="mainmenu">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="index.jsp">Available Centre</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="index.jsp">Book your slot</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="reportlogin.jsp">Know your vaccination status</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="index.jsp">Generate your report</a>
                </li>
                <li class="nav-item">
