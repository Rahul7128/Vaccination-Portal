      ...
      <div class="row">
        <div class="col-lg-12 p-0">
          <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="afterloginhome.jsp">
            ...
            <div class="collapse navbar-collapse" id="mainmenu">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                 ...
                 <li class="nav-item active">
                  <a class="nav-link" href="update.jsp">Update profile</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="centre.jsp">Vaccination Centres</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="medical.jsp" attributes-list download>Generate your report</a>
                </li>
                <li class="nav-item">
      ...
      <div class="row">
        <div class="col-lg-6 d-flex align-self-center">
          <div class="left-content">
            <div class="content">
              <h1 class="title">
                "India is set to defeat Covid-19. Every Indian is making it possible."<br>
                - PM Narendra Modi
              </h1>
            </div>
          </div>
        ...
        <div class="col-lg-6 order-first order-lg-last">
          <div class="right-img">
            <img class="img-fluid img" src="https://www.cowin.gov.in/assets/images/independance.svg" alt="">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="panel-group accordion" id="accordion-1">
            <div class="panel">
              <div class="panel-heading">
                <h4 data-toggle="collapse" aria-expanded="true" data-target="#one" aria-controls="one"
                  class="panel-title">
                  Which age groups can register for vaccination on the Vaccinate Me portal?
                </h4>
              </div>
            ...
            <div class="panel">
              <div class="panel-heading">
                <h4 data-toggle="collapse" aria-expanded="false" data-target="#four" aria-controls="four"
                  class="panel-title">
                  Can I download appointment slip?
                </h4>
              </div>
            ...
            <div class="panel">
              ...
              <div id="four2" class="panel-collapse collapse" aria-labelledby="four2" data-parent="#accordion-1">
                <div class="panel-body">
                    <p>
                      Once an appointment is scheduled, you will receive the details of the vaccination center, date and time slot chosen for appointment in an SMS sent to your registered mobile number. You can also download the appointment slip and print it or keep it on your smart phone.
                    </p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="info-box box2">
            ...
            <div class="right">
              <div class="content">
                <p>manager@vaccinateme.com</p>
                <p>reception@vaccinate.com</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="info-box box3">
            ...
            <div class="right">
              <div class="content">
                <p>Sri Aurobindo Marg, Ansari Nagar, Ansari Nagar East, New Delhi, Delhi 110029</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer class="footer" id="footer">
    ...
    <div class="copy-bg text-center">
      <p>Copyright © 2022. All rights reserved by
        <a href="afterloginhome.jsp">Software.Co</a>
      </p>
    </div>
  </footer>
  <!-- Footer Section End -->
